...
export default function OrganizationApplyPage() {
  ...
  const c = {
    ru: { label: "Заявка организации", title: "Регистрация в Vizora", intro: "Черновик сохраняется автоматически. После проверки чека администратор активирует тариф автоматически.", saved: "Заявка сохранена", demo: "Демонстрационный режим: после подключения Supabase заявка будет доступна по номеру и на другом устройстве.", edit: "Изменить данные", org: "Название организации *", full: "Полное название", type: "Тип организации *", choose: "Выберите", types: ["Компания", "Учебное учреждение", "Государственное учреждение", "Магазин", "Другое"], person: "ФИО ответственного лица *", personHint: "Имя и фамилия", position: "Должность *", positionHint: "Руководитель или администратор", phone: "Телефон *", email: "Электронная почта *", plan: "Выберите тариф", consent: "Я подтверждаю достоверность данных и согласен с правилами платформы.", save: "Сохранить заявку", activation: "Как проходит одобрение", steps: ["Заполните заявку", "Переведите оплату", "Загрузите подтверждение", "Дождитесь одобрения администратора"], requisites: "Реквизиты после заявки", check: "Проверка до 3 часов", kept: "Заявка сохраняется 7 дней", protected: "Защищённые данные", private: "Документы не публикуются" },
    tj: { label: "Дархости ташкилот", title: "Сабти ном дар Vizora", intro: "Нусхаи муваққатӣ худкор нигоҳ дошта мешавад. Пас аз санҷиши расид администратор тарофаро худкор фаъол мекунад.", saved: "Дархост нигоҳ дошта шуд", demo: "Реҷаи намоишӣ: пас аз пайваст кардани Supabase дархост аз рӯи рақам ва дар дастгоҳи дигар дастрас мешавад.", edit: "Тағйир додани маълумот", org: "Номи ташкилот *", full: "Номи пурра", type: "Навъи ташкилот *", choose: "Интихоб кунед", types: ["Ширкат", "Муассисаи таълимӣ", "Муассисаи давлатӣ", "Мағоза", "Дигар"], person: "Ному насаби шахси масъул *", personHint: "Ному насаб", position: "Вазифа *", positionHint: "Роҳбар ё маъмур", phone: "Телефон *", email: "Почтаи электронӣ *", plan: "Тарофаро интихоб кунед", consent: "Дурустии маълумотро тасдиқ намуда, ба қоидаҳои платформа розӣ ҳастам.", save: "Нигоҳ доштани дархост", activation: "Тасдиқ чӣ гуна мегузарад", steps: ["Дархостро пур кунед", "Пардохтро гузаронед", "Тасдиқномаро бор кунед", "Тасдиқи администраторро интизор шавед"], requisites: "Реквизитҳо пас аз дархост", check: "Санҷиш то 3 соат", kept: "Дархост 7 рӯз нигоҳ дошта мешавад", protected: "Маълумоти муҳофизатшуда", private: "Ҳуҷҷатҳо нашр намешаванд" },
    en: { label: "Organization application", title: "Register with Vizora", intro: "Your draft is saved automatically. After the receipt is verified, the administrator will activate the plan automatically.", saved: "Application saved", demo: "Demo mode: after Supabase is connected, the application will be available by number and on another device.", edit: "Edit information", org: "Organization name *", full: "Full legal name", type: "Organization type *", choose: "Choose", types: ["Company", "Educational institution", "Government institution", "Store", "Other"], person: "Authorized person’s full name *", personHint: "Full name", position: "Position *", positionHint: "Manager or administrator", phone: "Phone *", email: "Email *", plan: "Choose a plan", consent: "I confirm that the information is accurate and accept the platform rules.", save: "Save application", activation: "How approval works", steps: ["Complete the application", "Make the payment", "Upload confirmation", "Wait for administrator approval"], requisites: "Payment details after application", check: "Verification within 3 hours", kept: "Application is saved for 7 days", protected: "Protected information", private: "Documents are not published" }
  }[language];
