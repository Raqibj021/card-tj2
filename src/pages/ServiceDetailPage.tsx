...
import { nfcCardDesigns } from "../lib/nfcCardCatalog";
const content = {
  "custom-design": {
    icon: Paintbrush,
    order: "digital",
  ...
  "nfc-qr-signs": {
    ...
    ru: [
      "NFC- и QR-таблички",
      "Выберите формат для стойки, стола, двери или зоны обслуживания клиентов.",
      [
        "NFC и QR в одном решении",
        "Ваш логотип и фирменные цвета",
        "Несколько размеров и материалов",
      ],
    ],
    tj: [
      "Лавҳаҳои NFC ва QR",
      "Форматро барои пештахта, миз, дар ё минтақаи хизматрасонӣ интихоб кунед.",
      [
        "NFC ва QR дар як маҳсулот",
        "Лого ва рангҳои фирмавии шумо",
        "Андоза ва маводҳои гуногун",
      ],
    ],
    en: [
      "NFC and QR signs",
      "Choose a format for a counter, desk, door or customer service area.",
      [
        "NFC and QR in one product",
