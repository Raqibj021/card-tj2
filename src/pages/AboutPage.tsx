          ...
          <div className="site-container about-hero-layout">
            ...
            >
              <div className="about-founder-frame">
                <img
                  src={`${import.meta.env.BASE_URL}images/team/raqibjon-murodqulov-founder-v2.webp`}
                  alt="Ракибджон Муродкулов — основатель Vizora.tj"
                  width="1122"
                  height="1402"
                  loading="eager"
                  fetchPriority="high"
                />
                <div className="about-founder-shine" />
                <div className="about-founder-caption">
                  <BrandLogo compact light />
                  <div><small>{text.verified}</small><strong>Raqibjon Murodqulov</strong></div>
                  <BadgeCheck size={19} />
                </div>
              </div>
          ...
          <div className="site-container">
            <Reveal className="about-support-card">
              ...
              <div className="about-support-head">
                <img src={`${import.meta.env.BASE_URL}brand/buro-tezaurus-logo.webp`} alt="Бюро Тезаурус" width="2048" height="494" loading="lazy" />
        ...
        <section className="about-section about-contact-section">
          <div className="site-container about-contact-layout">
            <Reveal className="about-contact-intro">
              <SectionHeading label={text.contactsLabel} title={text.contactsTitle} />
              <p>{text.contactsText}</p>
              <div className="about-contact-identity">
                <img src={`${import.meta.env.BASE_URL}images/team/raqibjon-murodqulov-founder-v2.webp`} alt="" aria-hidden="true" loading="lazy" />
                <div><strong>Ракибджон Муродкулов</strong><span>{text.heroRole}</span></div>
              </div>
            </Reveal>
            <div className="about-contact-grid">
              {contacts.map(([label, value, href, Icon], index) => (
                <Reveal key={label} delay={index * 0.04}>
                  <a className="about-contact-link" href={href} target={href.startsWith("http") ? "_blank" : undefined} rel={href.startsWith("http") ? "noreferrer" : undefined}>
                    <span><Icon size={19} /></span><div><small>{label}</small><strong>{value}</strong></div><ExternalLink size={15} />
                  </a>
                </Reveal>
              ))}
            </div>
    ...
    <div className="about-network-visual" aria-hidden="true">
      <svg viewBox="0 0 620 500" role="img">
        ...
        <g className="about-network-nodes">
          <circle cx="310" cy="250" r="58" /><circle cx="130" cy="116" r="35" /><circle cx="500" cy="105" r="35" /><circle cx="520" cy="340" r="35" /><circle cx="125" cy="378" r="35" />
        </g>
      </svg>
      <div className="about-network-center"><BrandLogo compact light /></div>
